...
%feature("docstring") skoli_echo_ff "<+description+>"

%feature("docstring") skoli_echo_ff::skoli_echo_ff "

Params: (sample_rate, delay, echo_scaling)"

%feature("docstring") skoli_echo_ff::~skoli_echo_ff "

Params: (NONE)"

%feature("docstring") skoli_echo_ff::general_work "

Params: (noutput_items, ninput_items, input_items, output_items)"

%feature("docstring") skoli_make_echo_ff "<+description+>
